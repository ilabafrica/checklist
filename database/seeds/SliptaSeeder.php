...
class SliptaSeeder extends Seeder
{
    public function run()
    {
        ...
        *///  Section 11
        ...
        $question_labQManual = Question::create(array("section_id" => $sec_sec1->id, "name" => "Legal Entity", "title" => "1.1 Legal Entity", "description" => "Does the laboratory have documentation stating its legal identity?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        ...
        $question_labQMS = Question::create(array("section_id" => $sec_sec1->id, "name" => "Lab QMS Structure", "title" => "", "description" => "b) Documented policies for the quality management system that meet the requirements of ISO15189:2012 <strong>(Refer to Question 1.5 of this checklist for list of policies required)</strong>", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_labQStructure = Question::create(array("section_id" => $sec_sec1->id, "name" => "Structure defined ", "title" => "", "description" => "c) Description of the quality management system and the structure of its documentation", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_labSProcedures = Question::create(array("section_id" =>$sec_sec1->id, "name" => "Lab Supporting Procedures", "title" => "", "description" => "d) Reference to supporting procedures (SOPs), including managerial and technical procedures", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_labRoles = Question::create(array("section_id" => $sec_sec1->id, "name" => "Description of Lab Roles and Responsibilities", "title" => "", "description" => "e) Description of the roles and responsibilities of the laboratory director, or laboratory manager, quality manager, and other key personnel (laboratory to define its key personnel) responsible for ensuring compliance", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_labDocManReview = Question::create(array("section_id" => $sec_sec1->id, "name" => "Documentation of Annual Review", "title" => "", "description" => "f) Records of review and approval of the quality manual by authorized personnel", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_labPers = Question::create(array("section_id" => $sec_sec1->id, "name" => "Documentation of Annual Review", "title" => "", "description" => "g) Records to show that the quality manual was communicated to and understood by the lab personnel", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        ...
        $question_docRecords = Question::create(array("section_id" => $sec_sec1->id, "name" => "Document and Records", "title" => "1.4 Document and Records", "description" => "Are documents and records properly maintained, easily accessible and fully detailed in an up-to-date Master List?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        ...
        $question_referralExam = Question::create(array("section_id" => $sec_sec1->id, "name" => "Examination by Referral Laboratories", "title" => "Examination by Referral Laboratories and Consultants", "description" => "How the laboratory will: 1) select referral laboratories and consultants who provide opinions as well as interpretations; 2) evaluate and monitor the performance of referral laboratories and consultants who provide opinions as well as interpretations; 3) maintain a list of approved referral laboratories and consultants; 4) maintain a records of referred samples; 5) tracking of referred samples and their results; 6) report results from referral labs; 7) package and transport referred samples; 8) record communication of results from referral laboratories and consultants?", "question_type" => "0", "required" => "1", "info" => "Standard: ISO 15189: 4.5.1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_extSerSupp = Question::create(array("section_id" => $sec_sec1->id, "name" => "External Services and Suppliers", "title" => "External Services and Suppliers", "description" => "How the laboratory will: 1) select external purchases and services; 2) establish its selection criteria, including acceptance and rejection criteria; 3) approve and maintain its approved suppliers list; 4) define the requirements of its purchase supplies and services; 5) review and monitor the performance of its approved suppliers; 6) establish frequency of reviews ?", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_purInvCon = Question::create(array("section_id" => $sec_sec1->id, "name" => "Purchasing and Inventory Control", "title" => "Purchasing and Inventory Control", "description" => "How the laboratory will: 1) request, order and receive supplies; 2) establish acceptance/rejection criteria for purchased items; 3) store purchased supplies; 4) control their inventory; 5) monitor and handle expired consumables?", "question_type" => "0", "required" => "1", "info" => "Standard: ISO 15189: 4.6", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_advisory = Question::create(array("section_id" => $sec_sec1->id, "name" => "Advisory Services", "title" => "Advisory Services", "description" => "How the laboratory will: 1) request, order and receive supplies; 2) establish acceptance/rejection criteria for purchased items; 3) store purchased supplies; 4) control their inventory; 5) monitor and handle expired consumables?", "question_type" => "0", "required" => "1", "info" => "ISO 15189: 4.7", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_compFeedback = Question::create(array("section_id" => $sec_sec1->id, "name" => "Resolution of Complaints and Feedback", "title" => "Resolution of Complaints and Feedback", "description" => "How the laboratory will: 1) manage complaints received from clinicians, patients, laboratory staff or other parties; 2) collect, receive and handle feedback received from clinicians, patients, laboratory staff or other parties; 3) keep records of all complaints, the investigations and actions taken, 4) determine the timeframe for closure and feedback to the complainant; 5) monitor effectiveness of corrective and preventative actions taken on complaints and feedback?", "question_type" => "0", "required" => "1", "info" => "Standard: ISO 15189: 4.8", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        ...
        */
        ...
        $question_docConLog = Question::create(array("section_id" => $sec_sec1->id, "name" => "Document Control Log", "title" => "1.8 Document Control Log", "description" => "Are policies and procedures dated to reflect when it was put into effect, its location, when it was reviewed and when it was discontinued?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_discPoSops = Question::create(array("section_id" => $sec_sec1->id, "name" => "Discontinued Policies and SOPs", "title" => "1.9 Discontinued Policies and SOPs", "description" => "Are invalid or discontinued policies and procedures clearly marked / identified and removed from use and one copy retained for reference purposes?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        ...
        $question_arcResA = Question::create(array("section_id" => $sec_sec1->id, "name" => "Archived Results Accessibility", "title" => "1.11 Archived Results Accessibility", "description" => "Is there an archiving system that allows for easy and timely retrieval of archived records and results?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        ...
        $question_quaTechRecRev = Question::create(array("section_id" => $sec_sec2->id, "name" => "Routine Review of Quality and Technical Records", "title" => "2.1 Routine Review of Quality and Technical Records", "description" => "Does the laboratory routinely perform a documented review of all quality and technical records? Does the laboratory review include the following?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "5", "one_star" => "", "user_id" => "1"));
        $question_prevActItems = Question::create(array("section_id" => $sec_sec2->id, "name" => "Follow-up of action items from previous reviews", "title" => "", "description" => "a) Follow-up of action items from previous reviews", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_corrActStatus = Question::create(array("section_id" => $sec_sec2->id, "name" => "Status of corrective actions taken", "title" => "", "description" => "b) Status of corrective actions taken and required preventive actions", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_repFromPersonnel = Question::create(array("section_id" => $sec_sec2->id, "name" => "Reports from personnel", "title" => "", "description" => "c) Reports from personnel", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_envMonLog = Question::create(array("section_id" => $sec_sec2->id, "name" => "Environmental monitoring log sheets", "title" => "", "description" => "d) Environmental monitoring log sheets", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_speRejLog = Question::create(array("section_id" => $sec_sec2->id, "name" => "Specimen rejection logbook", "title" => "", "description" => "e) Specimen rejection logbook", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_equiCalibManRec = Question::create(array("section_id" => $sec_sec2->id, "name" => "Equipment calibration and maintenance records", "title" => "", "description" => "f) Equipment calibration and maintenance records", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_iqcRec = Question::create(array("section_id" => $sec_sec2->id, "name" => "IQC records across all test areas", "title" => "", "description" => "g) IQC records across all test areas", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_ptIntLabCo = Question::create(array("section_id" => $sec_sec2->id, "name" => "PTs and other forms of Inter-laboratory comparisons", "title" => "", "description" => "h) Outcomes of PTs and other forms of Inter-laboratory comparisons", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_qInd = Question::create(array("section_id" => $sec_sec2->id, "name" => "Quality indicators", "title" => "", "description" => "i) Quality indicators", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_custCompFeed = Question::create(array("section_id" => $sec_sec2->id, "name" => "Customer complaints and feedback", "title" => "", "description" => "j) Customer complaints and feedback", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_impProRes = Question::create(array("section_id" => $sec_sec2->id, "name" => "Results of improvement projects", "title" => "", "description" => "k) Results of improvement projects", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_revActPlanDoc = Question::create(array("section_id" => $sec_sec2->id, "name" => "Documentation of review and action planning", "title" => "", "description" => "l) Documentation of review and action planning with staff for resolution and follow-up review", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));

        $question_manRev = Question::create(array("section_id" => $sec_sec1->id, "name" => "Management Review", "title" => "2.2 Management Review", "description" => "Does the laboratory management perform a review of the quality system at a management review meeting at least annually?", "question_type" => "0", "required" => "1", "comment" => "", "score" => "5", "one_star" => "", "user_id" => "1"));
        $question_perRev = Question::create(array("section_id" => $sec_sec1->id, "name" => "Periodic Reviews", "title" => "", "description" => "a) The periodic review of requests, and suitability of procedures and sample requirements", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_feedAssess = Question::create(array("section_id" => $sec_sec1->id, "name" => "Assessment Feedback", "title" => "", "description" => "b) Assessment of user feedback", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_staffSugg = Question::create(array("section_id" => $sec_sec1->id, "name" => "Staff suggestions", "title" => "", "description" => "c) Staff suggestions", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_inAud = Question::create(array("section_id" => $sec_sec1->id, "name" => "Internal audits", "title" => "", "description" => "d) Internal audits", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_rskMan = Question::create(array("section_id" => $sec_sec1->id, "name" => "Risk management", "title" => "", "description" => "e) Risk management", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_quaInd = Question::create(array("section_id" => $sec_sec1->id, "name" => "Use of quality indicators", "title" => "", "description" => "f) Use of quality indicators", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_extAssess = Question::create(array("section_id" => $sec_sec1->id, "name" => "Assessments by external organizations", "title" => "", "description" => "g) Assessments by external organizations", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_interLab = Question::create(array("section_id" => $sec_sec1->id, "name" => "Results of participation in inter-laboratory", "title" => "", "description" => "h) Results of participation in inter-laboratory comparison programmes (PT/EQA)", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_monResConf = Question::create(array("section_id" => $sec_sec1->id, "name" => "Monitoring and resolution of complaints", "title" => "", "description" => "i) Monitoring and resolution of complaints", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_suppPerf = Question::create(array("section_id" => $sec_sec1->id, "name" => "Performance of suppliers", "title" => "", "description" => "j) Performance of suppliers", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_idConNon = Question::create(array("section_id" => $sec_sec1->id, "name" => "Identification and control of nonconformities", "title" => "", "description" => "k) Identification and control of nonconformities", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_contImp = Question::create(array("section_id" => $sec_sec1->id, "name" => "Continual Improvement", "title" => "", "description" => "l) Results of continual improvement including, current status of corrective actions and preventive actions", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_followUp = Question::create(array("section_id" => $sec_sec1->id, "name" => "Follow-up actions", "title" => "", "description" => "m) Follow-up actions from previous management reviews", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_volScope = Question::create(array("section_id" => $sec_sec1->id, "name" => "Changes in volume and scope", "title" => "", "description" => "n) Changes in the volume and scope of work, personnel, and premises that could affect the quality management system", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_recForImpro = Question::create(array("section_id" => $sec_sec1->id, "name" => "Recommendations for Improvement", "title" => "", "description" => "o) Recommendations for improvement, including technical requirements", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_quaObQuaPo = Question::create(array("section_id" => $sec_sec1->id, "name" => "Quality objectives and quality policy", "title" => "", "description" => "p) Review of quality objectives and the quality policy for appropriateness and continuous improvement", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_revOutRec = Question::create(array("section_id" => $sec_sec1->id, "name" => "Management Review recorded", "title" => "", "description" => "q) Are management review outputs recorded?", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_mrMeet = Question::create(array("section_id" => $sec_sec1->id, "name" => "MR meeting", "title" => "", "description" => "r) Does the output records of the MR meeting capture decisions made, persons responsible for actions to be taken and timeframes?", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_repAddRes = Question::create(array("section_id" => $sec_sec1->id, "name" => "Reports address resources", "title" => "", "description" => "s) Does the report address resources required (human, financial, material)?", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_refToImpro = Question::create(array("section_id" => $sec_sec1->id, "name" => "Refer to improvement", "title" => "", "description" => "t) Does it refer to improvement for the users?", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_effQuaSys = Question::create(array("section_id" => $sec_sec1->id, "name" => "Effectiveness of quality system", "title" => "", "description" => "u) Does it refer to improvement of the effectiveness of the quality system?", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_quaAppro = Question::create(array("section_id" => $sec_sec1->id, "name" => "Quality appropriateness", "title" => "", "description" => "v) Were the quality objectives and the quality policy reviewed for appropriateness and continuous improvement?", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_mrComm = Question::create(array("section_id" => $sec_sec1->id, "name" => "MR communication", "title" => "", "description" => "2.3 Are findings and actions from MR communicated to the relevant staff?", "question_type" => "0", "required" => "1", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_mrComp = Question::create(array("section_id" => $sec_sec1->id, "name" => "MR completed", "title" => "", "description" => "2.4 Does lab management ensure actions from MR are completed within defined timeframes?", "question_type" => "0", "required" => "1", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        
        /*$question_workVolChange = Question::create(array("section_id" => $sec_sec2->id, "name" => "Changes in volume and type of work", "title" => "", "description" => "2.2.4 Changes in volume and type of work the laboratory undertakes", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        ...
        */
        ...
        $question_duRoDaRo = Question::create(array("section_id" => $sec_sec3->id, "name" => "Duty Roster And Daily Routine", "title" => "3.1 Duty Roster And Daily Routine", "description" => "Does the laboratory have a duty roster that covers normal and after hours?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_orgChart = Question::create(array("section_id" => $sec_sec3->id, "name" => "Organizational Chart and External/Internal Reporting Systems", "title" => "3.2 Organizational Chart and External/Internal Reporting Systems", "description" => "Is an organizational chart available that indicates the relationship between the laboratory and its parent organization?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_labDir = Question::create(array("section_id" => $sec_sec3->id, "name" => "Laboratory Director", "title" => "3.3 Laboratory Director", "description" => "Is the laboratory directed by a person(s) with the competency, delegated responsibility to perform the following;", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "3", "one_star" => "", "user_id" => "1"));

        $question_effLead = Question::create(array("section_id" => $sec_sec3->id, "name" => "Effective Leadership", "title" => "", "description" => "a) Provide  effective  leadership,  budgeting  and planning", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_stakeComm = Question::create(array("section_id" => $sec_sec3->id, "name" => "Communication with stakeholders", "title" => "", "description" => "b) Communicate with stakeholders", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_adCompSta = Question::create(array("section_id" => $sec_sec3->id, "name" => "Adequate and competent staff", "title" => "", "description" => "c) Ensure adequate competent staff", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_qmsImp = Question::create(array("section_id" => $sec_sec3->id, "name" => "QMS implementation", "title" => "", "description" => "d) Ensure the implementation of the QMS", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_labSuppMon = Question::create(array("section_id" => $sec_sec3->id, "name" => "Monitoring of lab supplies", "title" => "", "description" => "e) Selection and monitoring of lab supplies", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_refLabMon = Question::create(array("section_id" => $sec_sec3->id, "name" => "Monitoring of referral labs", "title" => "", "description" => "f) Selection and monitoring of referral labs", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_safeLabEnv = Question::create(array("section_id" => $sec_sec3->id, "name" => "Safe Lab Environment", "title" => "", "description" => "g) Ensure a safe lab environment", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_advSer = Question::create(array("section_id" => $sec_sec3->id, "name" => "Advisory Services", "title" => "", "description" => "h) Advisory services", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_profDevProg = Question::create(array("section_id" => $sec_sec3->id, "name" => "Professional development programmes", "title" => "", "description" => "i) Provide professional development programs for laboratory staff", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_addCompReq = Question::create(array("section_id" => $sec_sec3->id, "name" => "Address complaint requests", "title" => "", "description" => "j) Address complaints, requests or suggestions from staff and/or lab users", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_contPlan = Question::create(array("section_id" => $sec_sec3->id, "name" => "Contingency Plan", "title" => "", "description" => "k) Design and implement a contingency plan", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        ...
        $question_jobDesc = Question::create(array("section_id" => $sec_sec3->id, "name" => "Job Description", "title" => "", "description" => "a) Is there an appointment letter, job description available or terms of reference?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_qmsProcess = Question::create(array("section_id" => $sec_sec3->id, "name" => "QMS Processes", "title" => "", "description" => "b) Does the quality manager ensure that processes needed for the quality management system are established, implemented, and maintained?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_qmReport = Question::create(array("section_id" => $sec_sec3->id, "name" => "QM Report", "title" => "", "description" => "c) Does the QM report to management at which decisions relating to quality are made?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_qmPromo = Question::create(array("section_id" => $sec_sec3->id, "name" => "QM Promote awareness", "title" => "", "description" => "d) Does the QM promote awareness of users’ needs and requirements throughout the organization?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_qmPart = Question::create(array("section_id" => $sec_sec3->id, "name" => "QM Participate in reviews", "title" => "", "description" => "e) Does the QM participate in management reviews?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));

        $question_perFilSys = Question::create(array("section_id" => $sec_sec3->id, "name" => "Personnel Filing System", "title" => "3.5 Personnel Filing System", "description" => "Are records of personnel maintained and do they include the following?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "3", "one_star" => "", "user_id" => "1"));
        
        $question_edProfQua = Question::create(array("section_id" => $sec_sec3->id, "name" => "Educational and professional qualifications", "title" => "", "description" => "a) Educational and professional qualifications", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_certOrLic = Question::create(array("section_id" => $sec_sec3->id, "name" => "Copy of certification or license to practice, when applicable", "title" => "", "description" => "b) Copy of certification or license to practice, when applicable", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_CV = Question::create(array("section_id" => $sec_sec3->id, "name" => "CV", "title" => "", "description" => "c) Previous work experience e.g. CV", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_jobDescr = Question::create(array("section_id" => $sec_sec3->id, "name" => "Job Description", "title" => "", "description" => "d) Job descriptions", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_newStaIntro = Question::create(array("section_id" => $sec_sec3->id, "name" => "Introduction of new staff to the laboratory environment", "title" => "", "description" => "e) Introduction of new staff to the laboratory environment", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_currJob = Question::create(array("section_id" => $sec_sec3->id, "name" => "Current Job Tasks", "title" => "", "description" => "f) Training in current job tasks including vendor training received on -site", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_compeAssess = Question::create(array("section_id" => $sec_sec3->id, "name" => "Competency Assessment", "title" => "", "description" => "g) Competency assessments", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_recContEd = Question::create(array("section_id" => $sec_sec3->id, "name" => "Records of continuing education", "title" => "", "description" => "h) Records of continuing education", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_revStaPerf = Question::create(array("section_id" => $sec_sec3->id, "name" => "Reviews of staff performance", "title" => "", "description" => "i) Reviews of staff performance", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_repOfAcc = Question::create(array("section_id" => $sec_sec3->id, "name" => "Reports of accidents", "title" => "", "description" => "j) Reports of accidents and exposure to occupational hazards", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_immuSta = Question::create(array("section_id" => $sec_sec3->id, "name" => "Immunization status, as applicable relevant to assigned duties", "title" => "", "description" => "k) Immunization status, as applicable relevant to assigned duties", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_empLetter = Question::create(array("section_id" => $sec_sec3->id, "name" => "Letter of employment or appointment", "title" => "", "description" => "l) Letter of employment or appointment", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_medSurvRec = Question::create(array("section_id" => $sec_sec3->id, "name" => "Employee medical surveillance records", "title" => "", "description" => "m) Employee medical surveillance records", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        // $question_qmReport = Question::create(array("section_id" => $sec_sec3->id, "name" => "", "title" => "", "description" => "", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        // $question_qmReport = Question::create(array("section_id" => $sec_sec3->id, "name" => "", "title" => "", "description" => "", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        ...
        */
        $question_labStaffTra = Question::create(array("section_id" => $sec_sec3->id, "name" => "Laboratory Staff Training", "title" => "3.6 Laboratory Staff Training", "description" => "Is there a system for training that covers the following?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "3", "one_star" => "", "user_id" => "1"));
        $question_qms = Question::create(array("section_id" => $sec_sec3->id, "name" => "The quality management system", "title" => "", "description" => "a) The quality management system", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_assWork = Question::create(array("section_id" => $sec_sec3->id, "name" => "Assigned work processes, procedures and tasks", "title" => "", "description" => "b) Assigned work processes, procedures and tasks", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_appLis = Question::create(array("section_id" => $sec_sec3->id, "name" => "The applicable laboratory information system", "title" => "", "description" => "c) The applicable laboratory information system", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        ...
        $question_labEth = Question::create(array("section_id" => $sec_sec3->id, "name" => "Laboratory Ethics", "title" => "", "description" => "e) Laboratory Ethics", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_confPatInfo = Question::create(array("section_id" => $sec_sec3->id, "name" => "Confidentiality of patient information", "title" => "", "description" => "f) Confidentiality of patient information", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_supTra = Question::create(array("section_id" => $sec_sec3->id, "name" => "Is there supervision for persons undergoing training", "title" => "", "description" => "g) Is there supervision for persons undergoing training", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_contMedEd = Question::create(array("section_id" => $sec_sec3->id, "name" => "Continuous medical education", "title" => "", "description" => "h) Continuous medical education", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_trainPro = Question::create(array("section_id" => $sec_sec3->id, "name" => "Review of effectiveness of the training program", "title" => "", "description" => "i) Review of effectiveness of the training program", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));

        $question_staffCompAudit = Question::create(array("section_id" => $sec_sec3->id, "name" => "Staff Competency Assessment and retraining", "title" => "3.7 Staff Competency Assessment and retraining", "description" => "Is there a system for competency assessment that covers the following?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "3", "one_star" => "", "user_id" => "1"));
        $question_defCrit = Question::create(array("section_id" => $sec_sec3->id, "name" => "Defined Criteria", "title" => "", "description" => "a) Are competency assessments performed according defined criteria", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_newHire = Question::create(array("section_id" => $sec_sec3->id, "name" => "New hires", "title" => "", "description" => "b) New hires", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_existSta = Question::create(array("section_id" => $sec_sec3->id, "name" => "Existing staff", "title" => "", "description" => "c) Existing staff", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_reTrareAss = Question::create(array("section_id" => $sec_sec3->id, "name" => "Retraining and re-assessment where needed", "title" => "", "description" => "d) Retraining and re-assessment where needed", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        
        $question_staffMeet = Question::create(array("section_id" => $sec_sec3->id, "name" => "Staff Meetings", "title" => "3.8 Staff Meetings", "description" => "Are staff meetings held regularly and do the meetings address the following items?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "4", "one_star" => "", "user_id" => "1"));
        $question_prevStaMeet = Question::create(array("section_id" => $sec_sec3->id, "name" => "Follow-up of action items from previous staff meeting", "title" => "", "description" => "a) Follow-up of action items from previous staff meeting", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_sysRecPro = Question::create(array("section_id" => $sec_sec3->id, "name" => "Systemic and or recurrent problems", "title" => "", "description" => "b) Systemic and or recurrent problems and issues addressed, including actions to prevent recurrence", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_complaints = Question::create(array("section_id" => $sec_sec3->id, "name" => "Complaints", "title" => "", "description" => "c) Complaints", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_commOnSops = Question::create(array("section_id" => $sec_sec3->id, "name" => "Communication on reviewed/revised/redundant SOPs", "title" => "", "description" => "d) Communication on reviewed/revised/redundant SOPs", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_priorCorrAct = Question::create(array("section_id" => $sec_sec3->id, "name" => "Review of results from prior corrective actions", "title" => "", "description" => "e) Review of results from prior corrective actions", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_evalOfImpro = Question::create(array("section_id" => $sec_sec3->id, "name" => "Discussion and evaluation of improvement topics/projects", "title" => "", "description" => "f) Discussion and evaluation of improvement topics/projects", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_hospMeetFeed = Question::create(array("section_id" => $sec_sec3->id, "name" => "Feedback given by staff", "title" => "", "description" => "g) Feedback given by staff that have attended hospital meetings, external meetings, training, conferences, workshops, etc.", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_relOfRep = Question::create(array("section_id" => $sec_sec3->id, "name" => "Relay of reports", "title" => "", "description" => "h) Relay of reports and updates from lab attendance at meetings with clinicians (the use of lab services and/or attendance at clinical rounds)", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_recMonMeetNotes = Question::create(array("section_id" => $sec_sec3->id, "name" => "Meeting notes", "title" => "", "description" => "i) Recording and monitoring of meeting notes for progress on issues.", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        // $question_qmReport = Question::create(array("section_id" => $sec_sec3->id, "name" => "", "title" => "", "description" => "j) ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        ...
        */
        ...
        $question_resOfComp = Question::create(array("section_id" => $sec_sec3->id, "name" => "Resolution of Complaints", "title" => "4.2 Resolution of Complaints", "description" => "Does the laboratory investigate (review) and resolves of customer complaints?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        ...
        $question_equipOper = Question::create(array("section_id" => $sec_sec5->id, "name" => "Equipment Operation", "title" => "5.2 Equipment Operation", "description" => "Are equipment operated by trained, competent and authorized personnel?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_equipMethVal = Question::create(array("section_id" => $sec_sec5->id, "name" => "Equipment and Method Validation", "title" => "5.3 Equipment and Method Validation/Verification and Documentation", "description" => "Are newly introduced equipment and methods validated/verified on-site and is documented evidence available?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "5", "one_star" => "", "user_id" => "1"));
        $question_specValVerPro = Question::create(array("section_id" => $sec_sec3->id, "name" => "Specific validation/verification protocol", "title" => "", "description" => "a) Are specific verification/validation protocols in place for each equipment and examination procedure?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_valPerf = Question::create(array("section_id" => $sec_sec3->id, "name" => "Validation performed", "title" => "", "description" => "b)  Is validation performed for all laboratory designed or developed methods, standard methods used outside their intended scope and validated methods that are subsequently modified?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_valInfo = Question::create(array("section_id" => $sec_sec3->id, "name" => "Validation information obtained", "title" => "", "description" => "c) Has validation information been obtained from the manufacturer/method developer as part of the verification?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_perfCharac = Question::create(array("section_id" => $sec_sec3->id, "name" => "Performance characteristics selected", "title" => "", "description" => "d) Have performance characteristics been appropriately selected and evaluated as per intended use?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_adeqValVer = Question::create(array("section_id" => $sec_sec3->id, "name" => "Adequate validation/verification", "title" => "", "description" => "e) Were the verification/validation studies appropriate and adequate?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_dataAn = Question::create(array("section_id" => $sec_sec3->id, "name" => "Analysis of data", "title" => "", "description" => "f) Was the analysis of data appropriate for the selected performance characteristics?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_valVerRep = Question::create(array("section_id" => $sec_sec3->id, "name" => "Validation/Verification Reports", "title" => "", "description" => "g) Have the verification/validation results/reports been reviewed and approved by an authorised person?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));

        $question_meQuaTests = Question::create(array("section_id" => $sec_sec3->id, "name" => "Measurement uncertainty of measured quantity tests", "title" => "5.4 Measurement uncertainty of measured quantity tests", "description" => "Does the laboratory have documented estimates of measurement of uncertainty (UM)?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_quantitative = Question::create(array("section_id" => $sec_sec3->id, "name" => "Quantitative measurement procedures", "title" => "", "description" => "a) Has the laboratory calculated the measurement uncertainty for each quantitative measurement procedure?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_defPerfReq = Question::create(array("section_id" => $sec_sec3->id, "name" => "Defined Performance Requirements", "title" => "", "description" => "b)  Has the laboratory defined the performance requirements (factors that affect the UM) for the measurement uncertainty of each measurement procedure and regularly review estimates of measurement uncertainty?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_calMeasure = Question::create(array("section_id" => $sec_sec3->id, "name" => "Calculated Measure of Uncertainty", "title" => "", "description" => "c) Does the lab make its calculated measurement of uncertainty available to its users upon request?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));

        $question_equipRecMan = Question::create(array("section_id" => $sec_sec5->id, "name" => "Equipment Record Maintenance", "title" => "5.5 Equipment Record Maintenance", "description" => "Is current equipment inventory data available on all equipment in the laboratory?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_equipName = Question::create(array("section_id" => $sec_sec5->id, "name" => "Name of equipment", "title" => "", "description" => "a) Name of equipment", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_manfCont = Question::create(array("section_id" => $sec_sec5->id, "name" => "Manufacturer's contact details", "title" => "", "description" => "b) Manufacturer’s or authorized supplier contact details", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_condReceived = Question::create(array("section_id" => $sec_sec5->id, "name" => "Condition received (new, used, reconditioned)", "title" => "", "description" => "c) Condition received (new, used, reconditioned)", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_serialNo = Question::create(array("section_id" => $sec_sec5->id, "name" => "Serial number", "title" => "", "description" => "d) Serial number", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_dateOfPur = Question::create(array("section_id" => $sec_sec5->id, "name" => "Date of receiving", "title" => "", "description" => "e) Date of receiving", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_outOfSer = Question::create(array("section_id" => $sec_sec5->id, "name" => "Date out of service", "title" => "", "description" => "f) Where equipment is obsolete, date when put 'out of service'", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_dateSerEntry = Question::create(array("section_id" => $sec_sec5->id, "name" => "Date of entry into service", "title" => "", "description" => "g) Date of entry into service(after validation / verification)", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_location = Question::create(array("section_id" => $sec_sec5->id, "name" => "Location", "title" => "", "description" => "h) Location", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));

        $question_equipManRec = Question::create(array("section_id" => $sec_sec5->id, "name" => "Equipment Maintenance Records", "title" => "5.6 Equipment Maintenance Records", "description" => "Is relevant equipment service information readily available in the laboratory?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_serviceContInf = Question::create(array("section_id" => $sec_sec5->id, "name" => "Service contract information", "title" => "", "description" => "a) Service contract information", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_serviceProCont = Question::create(array("section_id" => $sec_sec5->id, "name" => "Contact details for service provider", "title" => "", "description" => "b) Contact details for service provider", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_decontaRec = Question::create(array("section_id" => $sec_sec5->id, "name" => "Decontamination Records", "title" => "", "description" => "c) Decontamination Records", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_prevManRec = Question::create(array("section_id" => $sec_sec5->id, "name" => "Preventative maintenance records", "title" => "", "description" => "d) Engineer or service provider preventative maintenance records", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_lastSerDate = Question::create(array("section_id" => $sec_sec5->id, "name" => "Last date of service", "title" => "", "description" => "e) Last date of service", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_nextSerDate = Question::create(array("section_id" => $sec_sec5->id, "name" => "Next date of service", "title" => "", "description" => "f) Next date of service", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        
        $question_defEquip = Question::create(array("section_id" => $sec_sec5->id, "name" => "Defective Equipment Waiting for Repair", "title" => "5.7 Defective Equipment Waiting for Repair", "description" => "Is defective equipment, waiting for repair not used and clearly labelled?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        ...
        $question_equipCalibPro = Question::create(array("section_id" => $sec_sec5->id, "name" => "Adherence to Equipment Calibration Protocol", "title" => "5.9 Equipment Calibration and Metrological traceability Protocol", "description" => "Is routine calibration of laboratory equipment (including pipettes, centrifuges, balances, and thermometers) scheduled, as indicated on the equipment, and verified?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_routineCalib = Question::create(array("section_id" => $sec_sec3->id, "name" => "Routine Calibration", "title" => "", "description" => "a) Is routine calibration of laboratory ancillary equipment (including pipettes, centrifuges, balances, and thermometers) scheduled, at minimum following manufacturer recommendations and verified?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_traceCalib = Question::create(array("section_id" => $sec_sec3->id, "name" => "Traceable Calibration", "title" => "", "description" => "b) Is the calibration traceable (e.g. use of reference materials and equipment like certified thermometers, tachometer?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_reviewCalib = Question::create(array("section_id" => $sec_sec3->id, "name" => "Review of Calibration", "title" => "", "description" => "c) Is there evidence of review of calibrations certificates/results by the laboratory before acceptance back into use?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_certRefMat = Question::create(array("section_id" => $sec_sec3->id, "name" => "Certified Reference Materials", "title" => "", "description" => "d) Is certified reference materials, examination and calibration by another procedure, use of mutual consent standards or methods used for in house calibrations?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));

        $question_equipPrevMan = Question::create(array("section_id" => $sec_sec5->id, "name" => "Equipment Preventive Maintenance", "title" => "5.10 Equipment Preventive Maintenance", "description" => "Is routine preventive maintenance performed on all equipment and recorded according to manufacturer’s minimum requirements?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        ...
        $question_equipMalf = Question::create(array("section_id" => $sec_sec5->id, "name" => "Equipment Malfunction", "title" => "5.12 Equipment Malfunction - Response and Documentation", "description" => "Is equipment malfunction resolved by the effectiveness of the corrective action program and the associated root cause analysis?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        ...
        $question_repOrders = Question::create(array("section_id" => $sec_sec3->id, "name" => "Repair Orders", "title" => "", "description" => "a) Are repair orders monitored to determine if the service is completed?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_verDocEquip = Question::create(array("section_id" => $sec_sec3->id, "name" => "Verify and Document Equipment", "title" => "", "description" => "b) Does the laboratory verify and document the equipment is in proper working order before being put it back into service?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));

        $question_equipFailPlan = Question::create(array("section_id" => $sec_sec5->id, "name" => "Equipment Failure - Contingency Plan", "title" => "5.14 Equipment Failure - Contingency Plan", "description" => "Is there a functional back-up system that prevents interruption of lab services?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        ...
        $question_allQMS = Question::create(array("section_id" => $sec_sec3->id, "name" => "All QMS audited", "title" => "", "description" => "a) Is there an audit plan/schedule that ensures all activities of the QMS are audited?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_minConfOfIntr = Question::create(array("section_id" => $sec_sec3->id, "name" => "Minimal conflict of interest", "title" => "", "description" => "b) Are audits being carried with minimal conflict of interest e.g. where possible, carried out by persons who are not involved in lab activities in the section being audited?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_audPers = Question::create(array("section_id" => $sec_sec3->id, "name" => "Audit personnel trained", "title" => "", "description" => "c) Are the personnel conducting the internal audits trained with proven competency in auditing managerial and/or technical requirements?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_causeAnalPerf = Question::create(array("section_id" => $sec_sec3->id, "name" => "Cause Analysis Performed", "title" => "", "description" => "d) Is cause analysis performed for nonconformities/noted deficiencies?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_inAudFind = Question::create(array("section_id" => $sec_sec3->id, "name" => "Internal Audit Findings Presented", "title" => "", "description" => "e) Are internal audit findings documented and presented to the laboratory management and relevant staff for review?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_auditRecomm = Question::create(array("section_id" => $sec_sec6->id, "name" => "Audit Recommendations and Action Plan & Follow up", "title" => "6.2 Audit Recommendations and Action Plan & Follow up", "description" => "", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "5", "one_star" => "", "user_id" => "1"));
        $question_audRepGen = Question::create(array("section_id" => $sec_sec3->id, "name" => "Are internal audits reports generated?", "title" => "", "description" => "a) Are internal audits reports generated?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_corrPrevAct = Question::create(array("section_id" => $sec_sec3->id, "name" => "Corrective/Preventive Actions", "title" => "", "description" => "b) Are recommendations for corrective/preventive actions made based on audit findings?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_timeframe = Question::create(array("section_id" => $sec_sec3->id, "name" => "Follow-up within timeframe", "title" => "", "description" => "c) Is an action plan developed with clear timelines, assigned personnel & documented follow-up within the timeframe defined by the laboratory?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        
        $question_riskManage = Question::create(array("section_id" => $sec_sec3->id, "name" => "Risk Management", "title" => "6.3 Risk Management", "description" => "Are assessment of potential pitfalls performed for all laboratory processes including pre examination, examination and post examination?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "5", "one_star" => "", "user_id" => "1"));
        $question_assessPitfalls = Question::create(array("section_id" => $sec_sec3->id, "name" => "Assess Potential pitfalls", "title" => "", "description" => "a) Documented assessment of potential pitfalls for all processes", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_redPitfalls = Question::create(array("section_id" => $sec_sec3->id, "name" => "Reduce Potential Pitfalls", "title" => "", "description" => "b) Documented actions taken to reduce or eliminate identified potential pitfalls", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        ...
        $question_specForSupp = Question::create(array("section_id" => $sec_sec7->id, "name" => "", "title" => "7.2 Specification for supplies/consumables", "description" => "Does the laboratory provide specification for their supplies and consumables that are required when placing a requisition?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_serSuppPerfRev = Question::create(array("section_id" => $sec_sec7->id, "name" => "Service Supplier Performance Review", "title" => "7.3 Service Supplier Performance Review", "description" => "Does the lab monitor the performance of the suppliers to ensure that the stated criteria are met?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        
        $question_invCon = Question::create(array("section_id" => $sec_sec3->id, "name" => "Inventory Control", "title" => "7.4 Inventory Control", "description" => "Does the lab maintain records for each reagent and consumable that contributes to the performance of examinations. These records shall include but not be limited to the following:", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_reaCon = Question::create(array("section_id" => $sec_sec7->id, "name" => "Reagent or consumable", "title" => "", "description" => "a) Identity of the reagent or consumable?", "question_type" => "0", "required" => "1", "score" => "0", "user_id" => "1"));
        $question_batchLot = Question::create(array("section_id" => $sec_sec7->id, "name" => "Batch code or lot number?", "title" => "", "description" => "b) Batch code or lot number?", "question_type" => "0", "required" => "1", "score" => "0", "user_id" => "1"));
        $question_manSuppName = Question::create(array("section_id" => $sec_sec7->id, "name" => "Manufacturer or Supplier Name", "title" => "", "description" => "c) Manufacturer or supplier name and contact information?", "question_type" => "0", "required" => "1", "score" => "0", "user_id" => "1"));
        $question_receiptDate = Question::create(array("section_id" => $sec_sec7->id, "name" => "Date of receiving", "title" => "", "description" => "d) Date of receiving, the expiry date, date of entering into service and, where applicable, the date the material was taken out of service?", "question_type" => "0", "required" => "1", "score" => "0", "user_id" => "1"));
        $question_manPack = Question::create(array("section_id" => $sec_sec7->id, "name" => "Manufacturer instructions", "title" => "", "description" => "e) Manufacturer's instruction/package insert?", "question_type" => "0", "required" => "1", "score" => "0", "user_id" => "1"));
        $question_inspRec = Question::create(array("section_id" => $sec_sec7->id, "name" => "Inspection records", "title" => "", "description" => "f) Records of inspection of reagents and consumables when received (e.g. acceptable or damaged)?", "question_type" => "0", "required" => "1", "score" => "0", "user_id" => "1"));
        ...
        $question_budgetaryPro = Question::create(array("section_id" => $sec_sec7->id, "name" => "Budgetary Projections", "title" => "7.5 Budgetary Projections", "description" => "Are budgetary projections based on personnel, test, facility and equipment needs, and quality assurance procedures and materials?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_manRevSuppReq = Question::create(array("section_id" => $sec_sec7->id, "name" => "Management Review of Supply Requests", "title" => "7.6 Management Review of Supply Requests", "description" => "Does management review the finalized/approved supply requests?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_labInvSys = Question::create(array("section_id" => $sec_sec7->id, "name" => "Laboratory Inventory System", "title" => "7.7 Laboratory Inventory System", "description" => "", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_invRecComp = Question::create(array("section_id" => $sec_sec7->id, "name" => "Inventory Records Complete", "title" => "", "description" => "a) Are inventory records complete and accurate, with minimum and maximum stock levels denoted and monitored?", "question_type" => "0", "required" => "1", "score" => "0", "user_id" => "1"));
        $question_consRate = Question::create(array("section_id" => $sec_sec7->id, "name" => "Consumption Rate", "title" => "", "description" => "b) Is the consumption rate of all reagents and consumables monitored?", "question_type" => "0", "required" => "1", "score" => "0", "user_id" => "1"));
        $question_stockCounts = Question::create(array("section_id" => $sec_sec7->id, "name" => "Stock Counts", "title" => "", "description" => "c) Are stock counts routinely performed?", "question_type" => "0", "required" => "1", "score" => "0", "user_id" => "1"));
        ...
        */
        $question_storageArea = Question::create(array("section_id" => $sec_sec7->id, "name" => "Storage Area", "title" => "7.8 Storage Area", "description" => "Are storage areas set up and monitored appropriately?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_storageWellOrg = Question::create(array("section_id" => $sec_sec7->id, "name" => "Storage area well-organized", "title" => "", "description" => "a) Is the storage area well-organized and free of clutter?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_desigPlaces = Question::create(array("section_id" => $sec_sec7->id, "name" => "Designated places", "title" => "", "description" => "b) Are there designated places labeled for all inventory items for easy access?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_coldStorage = Question::create(array("section_id" => $sec_sec7->id, "name" => "Adequate cold storage", "title" => "", "description" => "c) Is adequate cold storage available?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_storageAreaMon = Question::create(array("section_id" => $sec_sec7->id, "name" => "Storage areas monitored", "title" => "", "description" => "d) Are storage areas monitored as per prescribed storage conditions?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_ambientTemp = Question::create(array("section_id" => $sec_sec7->id, "name" => "Ambient temperature", "title" => "", "description" => "e) Is the ambient temperature monitored routinely?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_directSunlight = Question::create(array("section_id" => $sec_sec7->id, "name" => "Storage in direct sunlight", "title" => "", "description" => "f) Is storage in direct sunlight avoided?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_adequateVent = Question::create(array("section_id" => $sec_sec7->id, "name" => "Storage area adequately ventilated", "title" => "", "description" => "g) Is the storage area adequately ventilated?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_cleanDustPests = Question::create(array("section_id" => $sec_sec7->id, "name" => "Clean and free of dust and pests", "title" => "", "description" => "h) Is the storage area clean and free of dust and pests?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_accessControl = Question::create(array("section_id" => $sec_sec7->id, "name" => "Storage areas access-controlled", "title" => "", "description" => "i) Are storage areas access-controlled?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        
        $question_wastageMin = Question::create(array("section_id" => $sec_sec7->id, "name" => "Inventory Organization and Wastage Minimization", "title" => "7.9 Inventory Organization and Wastage Minimization", "description" => "Is First-Expiration-First-Out (FEFO) practiced?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_dispExProd = Question::create(array("section_id" => $sec_sec7->id, "name" => "Disposal of Expired Products", "title" => "7.10 Disposal of Expired Products", "description" => "Are expired products labeled and disposed properly?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_prodExpiration = Question::create(array("section_id" => $sec_sec7->id, "name" => "Product Expiration", "title" => "7.11 Product Expiration", "description" => "Are all reagents/test kits in use (and in stock) currently within the manufacturer-assigned expiration dates or within stability?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        ...
        $question_adSampInfo = Question::create(array("section_id" => $sec_sec8->id, "name" => "Adequate sample receiving procedures", "title" => "8.2 Does the laboratory adequately collect information needed for examination performance?", "description" => "", "question_type" => "0", "required" => "1", "info" => "", "score" => "3", "one_star" => "", "user_id" => "1"));
        $question_testReqForm = Question::create(array("section_id" => $sec_sec3->id, "name" => "Test Requisition Form", "title" => "", "description" => "a) Are all test requests accompanied by an acceptable and approved test requisition form (and a transmittal sheet/checklist/manifest where applicable)?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_ptId = Question::create(array("section_id" => $sec_sec3->id, "name" => "Patient identification", "title" => "", "description" => "b) Does the request form has patient ID including gender, date of birth, location of patient and unique identifier?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_authReq = Question::create(array("section_id" => $sec_sec3->id, "name" => "Authorized requester", "title" => "", "description" => "c) Name, signature or initials of authorized requester", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_exam = Question::create(array("section_id" => $sec_sec3->id, "name" => "Examination requested", "title" => "", "description" => "d) Type of sample and examination requested", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_relInfo = Question::create(array("section_id" => $sec_sec3->id, "name" => "Relevant Information", "title" => "", "description" => "e) Clinically relevant information", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_collDate = Question::create(array("section_id" => $sec_sec3->id, "name" => "Collection date", "title" => "", "description" => "f) Date of sample collection (And time of collection where relevant – where time has an impact on the result)", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_receiptTime = Question::create(array("section_id" => $sec_sec3->id, "name" => "DateTime sample receipt", "title" => "", "description" => "g) Date and time of sample receipt", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_consent = Question::create(array("section_id" => $sec_sec3->id, "name" => "Written consent", "title" => "", "description" => "i) Written consent for invasive procedures with increased risk of complications", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        
        $question_sampRecPro = Question::create(array("section_id" => $sec_sec8->id, "name" => "Adequate sample receiving procedures", "title" => "8.3 Are adequate sample receiving procedures in place?", "description" => "", "question_type" => "0", "required" => "1", "info" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_patUniq = Question::create(array("section_id" => $sec_sec3->id, "name" => "Patient Unique Identifier", "title" => "", "description" => "a) Patient Unique Identifier", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_accRejCrit = Question::create(array("section_id" => $sec_sec3->id, "name" => "Acceptance/Rejection Criteria", "title" => "", "description" => "b) Are received specimens evaluated according to acceptance/rejection criteria?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_specLog = Question::create(array("section_id" => $sec_sec3->id, "name" => "Specimen log", "title" => "", "description" => "c) Are specimens logged appropriately upon receipt in the laboratory (including date, time, and name of receiving officer)?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_verbalReq = Question::create(array("section_id" => $sec_sec3->id, "name" => "Verbal requests", "title" => "", "description" => "d) Are procedures in place to process 'urgent' specimens and verbal requests?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_splitSamp = Question::create(array("section_id" => $sec_sec3->id, "name" => "Split Sample", "title" => "", "description" => "e) When samples are split, can the portions be traced back to the primary sample?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_24hour = Question::create(array("section_id" => $sec_sec3->id, "name" => "24 hour Lab", "title" => "", "description" => "f) If not a 24 hour lab, is there a documented method for handling of specimens received after hours?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_corrWorksta = Question::create(array("section_id" => $sec_sec3->id, "name" => "Correct Workstation", "title" => "", "description" => "g) Are specimens delivered to the correct workstations in a timely manner?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_preExHand = Question::create(array("section_id" => $sec_sec8->id, "name" => "Pre-examination Handling, Preparation and Storage", "title" => "8.4 Pre-examination Handling, Preparation and Storage", "description" => "Where testing does not occur immediately upon arrival in the laboratory, are specimens stored appropriately prior to testing?", "question_type" => "0", "required" => "1", "info" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_sampTrans = Question::create(array("section_id" => $sec_sec8->id, "name" => "Sample Transportation", "title" => "8.5 Sample Transportation", "description" => "Are specimens either received or referred packaged appropriately according to local and or international regulations and transported within acceptable timeframes and temperature intervals?", "question_type" => "0", "required" => "1", "info" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_evalRefLabs = Question::create(array("section_id" => $sec_sec8->id, "name" => "Does the laboratory select and evaluate referral Labs and Consultants?", "title" => "8.6 Does the laboratory select and evaluate referral Labs and Consultants?", "description" => "", "question_type" => "0", "required" => "1", "info" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_refLabCons = Question::create(array("section_id" => $sec_sec3->id, "name" => "Referral Lab Consultants", "title" => "", "description" => "a) Are there documented reviews and evaluations of referral laboratories and consultants as defined by the laboratory?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_refLabRej = Question::create(array("section_id" => $sec_sec3->id, "name" => "Referral Lab Register", "title" => "", "description" => "b) Is there a register of referral Laboratories and consultants?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_refSpec = Question::create(array("section_id" => $sec_sec3->id, "name" => "Referral Specimen tracked appropriately", "title" => "", "description" => "c) Are referred specimens tracked properly using a logbook, tracking form or electronically?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_docExProc = Question::create(array("section_id" => $sec_sec8->id, "name" => "Documentation of examination procedures", "title" => "8.7 Documentation of Examination Procedures", "description" => "Are examination procedures documented in a language commonly understood by all staff and available in appropriate locations?", "question_type" => "0", "required" => "1", "info" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_reAcc = Question::create(array("section_id" => $sec_sec8->id, "name" => "Reagents Acceptance Testing", "title" => "8.8 Reagents Acceptance Testing", "description" => "Is each new reagent preparation, new lot number, new shipment of reagents or consumables verified before use and documented?", "question_type" => "0", "required" => "1", "info" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_quaCon = Question::create(array("section_id" => $sec_sec8->id, "name" => "Quality Control", "title" => "8.9 Quality Control", "description" => "Is internal quality control performed, documented, and verified for all tests/procedures before releasing patient results?", "question_type" => "0", "required" => "1", "info" => "", "score" => "3", "one_star" => "", "user_id" => "1"));
        $question_quaConData = Question::create(array("section_id" => $sec_sec8->id, "name" => "Quality Control Data", "title" => "8.10 Quality Control Data", "description" => "Are QC results monitored and reviewed (including biases and Levy-Jennings charts for quantitative tests)?", "question_type" => "0", "required" => "1", "info" => "", "score" => "3", "one_star" => "", "user_id" => "1"));
        $question_corrAcDoc = Question::create(array("section_id" => $sec_sec3->id, "name" => "Corrective Actions Documentation", "title" => "", "description" => "a) Is there documentation of corrective action taken when quality control results exceed the acceptable range or reviews identify non conformities in a timely manner?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_resEval = Question::create(array("section_id" => $sec_sec3->id, "name" => "Control Results Evaluation", "title" => "", "description" => "b) Does the Lab evaluate the results from the patient samples that were examined after the last successful quality control event", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        // $question_specLog = Question::create(array("section_id" => $sec_sec3->id, "name" => "", "title" => "", "description" => "c) ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        ...
        $question_testPersonnel = Question::create(array("section_id" => $sec_sec9->id, "name" => "Testing Personnel", "title" => "9.2 Testing Personnel", "description" => "Are testing personnel identified on the result report or other records (manual or electronic)?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_testResRec = Question::create(array("section_id" => $sec_sec9->id, "name" => "Report Content", "title" => "9.3 Report Content", "description" => "Does the laboratory report contain at least the following:", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_testRequested = Question::create(array("section_id" => $sec_sec9->id, "name" => "Test requested", "title" => "", "description" => "a) Test requested", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_labIdentification = Question::create(array("section_id" => $sec_sec9->id, "name" => "Identification of the laboratory", "title" => "", "description" => "b) Identification of the laboratory", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_examIdentification = Question::create(array("section_id" => $sec_sec9->id, "name" => "Identification of examinations", "title" => "", "description" => " c) Identification of all examinations performed by a referral laboratory ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_patientIdentification = Question::create(array("section_id" => $sec_sec9->id, "name" => "Identification of Patient", "title" => "", "description" => "d) Patient identification and location ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_nameRequester = Question::create(array("section_id" => $sec_sec9->id, "name" => "Requester Name", "title" => "", "description" => "e) Name of the requester ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_primaryDate = Question::create(array("section_id" => $sec_sec9->id, "name" => "Primary Date", "title" => "", "description" => "f) Date of primary sample collection (and time, relevant to patient care)", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_primaryTypeSample = Question::create(array("section_id" => $sec_sec9->id, "name" => "Primary Sample", "title" => "", "description" => "g) Type of primary sample", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_resultReported = Question::create(array("section_id" => $sec_sec9->id, "name" => "Results Reported", "title" => " ", "description" => "h) Is the result reported in SI units where applicable?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_biologicalRefrence= Question::create(array("section_id" => $sec_sec9->id, "name" => "Biological Refrence", "title" => "", "description" => "i) Biological reference intervals where applicable", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_interpretationSpace= Question::create(array("section_id" => $sec_sec9->id, "name" => "interpretation Space", "title" => "", "description" => "j) Is there space for interpretation or comments of results, when applicable?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_authorizingReports= Question::create(array("section_id" => $sec_sec9->id, "name" => "Person Authorizing Reports", "title" => "", "description" => "k) Identification of the person(s) reviewing and authorizing the report", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_dateTime= Question::create(array("section_id" => $sec_sec9->id, "name" => "Date and Time", "title" => "","description"=> "l) Date and time of the report ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_pageNumber= Question::create(array("section_id" => $sec_sec9->id, "name" => "Page Number", "title" => "","description" => "m) Page number to total number of pages (e.g. "Page 1 of 5", "Page 2 of 5", etc.) ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_revisedReports= Question::create(array("section_id" => $sec_sec9->id, "name" => "Issuing Revised Reports", "title" => "","description" => " n) When issuing revised reports, is it clearly identified as a revision and includes reference to the date and patient's identity in the original report and the user made aware of the revision?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_revisedReportsDate= Question::create(array("section_id" => $sec_sec9->id, "name" => "Revised Records Show Time and Date", "title" => "","description" => "o) Does the revised record show the time and date of the change and the name of the person responsible for the change?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_OriginalReport= Question::create(array("section_id" => $sec_sec9->id, "name" => "Original Report Entry", "title" => "","description" => "p) Does the original report entry remain in the record when revisions are made?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        ...
        $question_authoritiesResp = Question::create(array("section_id" => $sec_sec9->id, "name" => "Authorities and Responsibilities", "title" => "9.6 Authorities and Responsibilities ", "description" => "Has the laboratory defined and implemented authorities and responsibilities for the management and use of the laboratory information system– paper based and electronic, including maintenance and modifications that may affect patient care?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_isTheFollowing = Question::create(array("section_id" => $sec_sec9->id, "name" => "Is the Following", "title" => "Is the following in place and implemented? ", "description" => " ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_controlledAccess = Question::create(array("section_id" => $sec_sec9->id, "name" => "Controlled Access", "title" => "", "description" => "a) Controlled access to patient data and information", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_controlledAccessEnter = Question::create(array("section_id" => $sec_sec9->id, "name" => "Controlled Access to Enter Patient", "title" => "", "description" => "b) Controlled access to enter patient data and examination results ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_controlledAccessChanging = Question::create(array("section_id" => $sec_sec9->id, "name" => "Controlled Access to changing Patient", "title" => "", "description" => "c) Controlled access to changing patient data or examination results ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_controlledAccessRelease = Question::create(array("section_id" => $sec_sec9->id, "name" => "Controlled Access to Release Patient", "title" => "", "description" => "d) Controlled access to the release of examination results and reports", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_verifyResults = Question::create(array("section_id" => $sec_sec9->id, "name" => "Verification of Results", "title" => "Verify that results that have been transmitted electronically or reproduced external to the laboratory (computers, fax machines, email and websites and personal web devices) are correct" => " ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_backupSys = Question::create(array("section_id" => $sec_sec9->id, "name" => "Information Management System", "title" => "9.7 Information Management System", "description" => "Does the laboratory have evidence of how the LIMS was selected?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_testResReport = Question::create(array("section_id" => $sec_sec9->id, "name" => "Test Result ", "title" => "9.8 Test Result Report", "description" => "Are test results validated, interpreted and released by appropriately-authorized personnel?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "1", "user_id" => "1"));
        $question_electronicVerification = Question::create(array("section_id" => $sec_sec9->id, "name" => "Verification of Electronic", "title" => "9.9 Verification of Electronic Laboratory Information System", "description" => "", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "1", "user_id" => "1"));
        $question_sysVerification = Question::create(array("section_id" => $sec_sec9->id, "name" => "System been verified before implementation", "title" => "", "description" => "a) Has the system been verified before implementation that include the verification reports to check functioning and inter-phasing by the laboratory?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "1", "user_id" => "1"));
        $question_RecordValidation= Question::create(array("section_id" => $sec_sec9->id, "name" => "Records Validation", "title" => "", "description" => "b) Records of the validation by the supplier available and approved for use?", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_systemChecks = Question::create(array("section_id" => $sec_sec9->id, "name" => "Ongoing System Checks", "title" => "", "description" => "c) Ongoing system checks available for correct transmissions, calculations and storage of results and records.", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_labSystemMentained = Question::create(array("section_id" => $sec_sec9->id, "name" => "Laboratory Information System properly maintained", "title" => "9.10 Is the Laboratory Information System properly maintained to ensure continued functioning:", "description" => " ", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "2", "one_star" => "", "user_id" => "1"));
        $question_docRegularservice = Question::create(array("section_id" => $sec_sec9->id, "name" => "Documentation Regular Service", "title" => "", "description" => "a) Documented regular service by authorized and trained personnel", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_dcoSystemFailure = Question::create(array("section_id" => $sec_sec9->id, "name" => " Documented System Failure", "title" => "", "description" => "b) Documented system failures with documented appropriate root cause analysis, corrective actions and preventative actions", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
        $question_operationEnvironment= Question::create(array("section_id" => $sec_sec9->id, "name" => "System Operation Environment", "title" => "", "description" => "c) System operated in an environment recommended by the supplier for optimal functioning", "question_type" => "0", "required" => "1", "info" => "", "comment" => "", "score" => "0", "one_star" => "", "user_id" => "1"));
