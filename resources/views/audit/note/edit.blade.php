...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li class="active">{{ Lang::choice('messages.edit-note', 1) }}</li>
        </ol>
    </div>
</div>
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.edit-note', '1') }}</div>
    <div class="panel-body">
        <div class="col-lg-6 main">
            ...
            @endif
            {!! Form::model($note, array('route' => array('note.update', $note->id), 
        'method' => 'PUT', 'id' => 'form-edit-note', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
