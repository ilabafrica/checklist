    ...
    <div class="panel-body">
        ...
        'method' => 'PUT', 'id' => 'form-edit-audit-type', 'class' => 'form-horizontal')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        {!! Form::select('question_type', array(''=>trans('messages.select-question-type'))+$questionTypes,
                ...
                <div class="form-group">
                    {!! Form::label('title', Lang::choice('messages.label', 1), array('class' => 'col-sm-4 control-label')) !!}
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        {!! Form::select('section_id', array(''=>trans('messages.select-section'))+$sections,
                ...
                <div class="form-group">
                    <div class="col-sm-offset-4 col-sm-8">
                        <label class="checkbox-inline">
                            {!! Form::checkbox("one_star", '1', '') !!}{{ Lang::choice('messages.one-star', 1) }}
                        </label>
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('answer', Lang::choice('messages.select-answer', 1), array('class' => 'col-sm-4 control-label')) !!}
                    <div class="col-sm-8">
                            ...
                            @foreach($notes as $key=>$value)
                                ...
                                <div class="col-md-6">
                                    <label  class="checkbox-inline">
                                        ...
                                        {{ in_array($value->id, $question->notes->lists('id'))?"checked":"" }} />
                                        {{$value->name }}
                                    </label>
                                </div>
                                {!! ($cnt%4==0)?"</div>":"" !!}
