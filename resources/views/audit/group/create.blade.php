...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.create-audit-field-group', '1') }}</div>
    <div class="panel-body">
        <div class="col-lg-6 main">
            ...
            @endif
            {!! Form::open(array('route' => 'auditFieldGroup.store', 'id' => 'form-add-audit-field-group', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
