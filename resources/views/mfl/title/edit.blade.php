...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.edit-title', '1') }}</div>
    <div class="panel-body">
        <div class="col-lg-6 main">
            ...
            @endif
            {!! Form::model($title, array('route' => array('title.update', $title->id), 
        'method' => 'PUT', 'id' => 'form-edit-title', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
