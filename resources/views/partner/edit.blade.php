...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            ...
            <li class="active">{{ Lang::choice('messages.edit-partner', 1) }}</li>
        </ol>
    </div>
</div>
...
<div class="panel panel-primary">
    <div class="panel-heading"><i class="fa fa-tags"></i> {{ Lang::choice('messages.edit-partner', '1') }}</div>
    <div class="panel-body">
        <div class="col-lg-12 main">
            ...
            @endif
            {!! Form::model($partner, array('route' => array('partner.update', $partner->id), 'method' => 'PUT', 'id' => 'form-edit-partner', 'class' => 'form-horizontal')) !!}
                <!-- CSRF Token -->
                            ...
                            @foreach($labs as $key=>$value)
                                ...
                                <div class="col-md-3">
                                    <label  class="checkbox-inline">
                                        <input type="checkbox" name="labs[]" value="{{ $value->id}}" 
                                            {{ in_array($value->id, $partner->labs->lists('id'))?"checked":"" }} />
                                            {{$value->name }}
                                    </label>
                                </div>
                                {{ ($cnt%4==0)?"</div>":"" }}
